...
def main():
    script_name = "fertilizer_bronze"  # Hardcode the script name without extension
    spark = SparkSession.builder.appName("FertilizerBronzeLayer").getOrCreate()

    s3_path = "s3://tendo-de-test/fertilizer.csv" # TODO: look for filename patterns for future loads
