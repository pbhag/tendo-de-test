...
def main():
    script_name = "purchase_bronze"  # Hardcode the script name without extension
    spark = SparkSession.builder.appName("PurchaseBronzeLayer").getOrCreate()

    s3_path = "s3://tendo-de-test/purchase.csv" # TODO: look for filename patterns for future loads
